...
<h1 class="best_classKoord2">Оргтехника</h1>
<section class="section_best1">
    <ul class="ulotstup1">
        <li class="Otrydi"><button class="buttonOtryd" href="Filial.php" class="Otrydi"><a href="Filial.php" class="ae"><text class = "textOtryd"> Управление филиала </li></button>
